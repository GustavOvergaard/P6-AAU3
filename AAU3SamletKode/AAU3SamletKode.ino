...
void setup() {
  ...
  xTaskCreate(test, "test", 1000, NULL, 2, NULL);
...
void test(void *pvParameters ) {
  ...
  for (;;) {
    vTaskDelayUntil(&xLastWakeTime, xPeriod);
    Serial.print(potmeter(),5); Serial.print(","); Serial.print(komplementaerFilter(0.99),5);Serial.print(","); Serial.print(komplementaerFilter(0.98),5);Serial.print(","); Serial.println(komplementaerFilter(0.97),5);
  }
}
