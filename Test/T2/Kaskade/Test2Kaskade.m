...
start=[115;5089;8278;11349;14503;17649;20894;24163;27390;31031];
%start(1)=1144
%for i=2:10
...
for i=1:10
    ...
    a=sprintf('Kaskade regulator T.2 gentagelse %d',i);
    title(a)
    ylabel("Vinkel [rad]");
    xlabel("Tid [s]");
    yline(0.0175);
    ...
    a=sprintf('Strøminput ved kaskade regulator T.2 gentagelse %d',i);
    title(a)
    ylabel("Strøm [A]");
    xlabel("Tid [s]");
end
