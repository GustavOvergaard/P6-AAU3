...
start=[146;3280;7167;12045;17688;20912;45367;24366;27761;38253]
...
offset = temp/(n-1000);
offset(10)=offset(10)+0.002;
offset(9)=offset(9);
offset(8)=offset(8)+0.003;
offset(7)=offset(7);
offset(6)=offset(6)+0.002;
offset(5)=offset(5);
offset(4)=offset(4)+0.002;
offset(3)=offset(3)+0.005;
offset(2)=offset(2);
...
for i=1:10
    ...
    a=sprintf('Strøminput ved ydre regulator T.3 gentagelse %d',i);
    title(a)
    ylabel("Strøm [A]");
    xlabel("Tid [s]");
end
