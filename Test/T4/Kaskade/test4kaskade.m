...
start=[331;3002;6380;15122;18121;20971;23784;30079;33458;35904];
%start(1)=1144
%for i=2:10
...
for i=1:10
    ...
    yline(0.0175);
    yline(-0.0175);
    datatip(plotVar(i),addMarkX(i),addMarkY(i));
    subplot(2,1,2);
    plot(tid,dataFiltStroem(:,i));
    a=sprintf('Strøminput ved kaskade regulator T.4 gentagelse %d',i);
    title(a)
    ylabel("Strøm [A]");
    xlabel("Tid [s]");
end
