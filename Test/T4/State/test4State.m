...
%32986
start=[308;2534;32986;13086;18463;21228;24512;27050;30031;35994]
%start(1)=1144
%for i=2:10
...
for i=1:10
    ...
    a=sprintf('State space regulator T.4 gentagelse %d',i);
    title(a)
    ylabel("Vinkel [rad]");
    xlabel("Tid [s]");
    yline(0.0175);
    ...
    a=sprintf('Strøminput ved state space regulator T.4 gentagelse %d',i);
    title(a)
    ylabel("Strøm [A]");
    xlabel("Tid [s]");
end
